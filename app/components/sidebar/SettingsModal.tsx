    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-12">
          {/* border-gray-900/10  --/10 means opacity-10 */}
            ...
            <div className="mt-10 flex flex-col gap-y-8">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                <Image
                  ...
                  src={image || currentUser?.image || "/images/avatardefault.jpg"}
                  alt="Avatar"
                />
                <CldUploadButton options={{ maxFiles: 1 }} onUpload={handleUpload} uploadPreset="ocrwlbl8">
